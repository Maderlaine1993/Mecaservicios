        ...
        <div class=" row justify-content-center">
            ...
            <!-- Validacion de Errores -->
                ...
                <div class="card" style="border-color: #8B716C">
                    <form action=" {{ route('updateServicio', $servicio->id_servicio) }}" method="POST">
                        @csrf @method("PATCH")

                        <div class=" card-header text-center" style="background-color: #a4c2f4; border-color: #8B716C">
                            <h2 style="color: #8B716C"><i class="fas fa-tools"></i> Modifica el Servicio: #<i>{{$servicio->id_servicio}}</i></h2>
                        </div>
                        <br>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg">
                                    <input type="text" name="snombre" class="form-control" value="{{$servicio->snombre}}" placeholder="Nombre">
                                </div>

                                <div class="col-lg">
                                    <input type="text" name="scosto" class="form-control" value="{{$servicio->scosto}}" placeholder="Costo">
                                </div>
                            </div>
